...
summary: Sobald Ihr Azure Blob Storage-System auf der Systemseite der NetApp Console verfügbar ist, können Sie weitere Speicherkonten direkt von der Konsole aus hinzufügen. 
---
= Azure Blob-Speicherkonten in der NetApp Console hinzufügen
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Sobald Ihr Azure Blob Storage-System auf der Systemseite der NetApp Console verfügbar ist, können Sie weitere Speicherkonten direkt von der Konsole aus hinzufügen.
