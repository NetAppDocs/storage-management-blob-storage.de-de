...
summary: Nachdem Sie Azure Blob-Speicherkonten in der NetApp Console ermittelt haben, können Sie NetApp Datendienste für Sicherung, Tiering und Datensynchronisierung verwenden. 
---
...
[role="lead"]
Nachdem Sie Azure Blob-Speicherkonten in der NetApp Console ermittelt haben, können Sie NetApp Datendienste für Sicherung, Tiering und Datensynchronisierung verwenden.
