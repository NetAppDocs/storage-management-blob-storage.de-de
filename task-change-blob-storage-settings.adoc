...
summary: Sobald Ihr Azure Blob Storage-System auf der Seite „Systeme“ verfügbar ist, können Sie einige Speicherkontoeigenschaften direkt über die NetApp Console ändern. 
---
= Ändern der Azure Blob Storage-Kontoeinstellungen in der NetApp Console
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Sobald Ihr Azure Blob Storage-System auf der Seite „Systeme“ verfügbar ist, können Sie einige Speicherkontoeigenschaften direkt über die NetApp Console ändern.
