...
.Schritte
. https://docs.netapp.com/us-en/bluexp-setup-admin/task-quick-start-connector-azure.html["Installieren eines Konsolenagenten"^]in dem Azure-Konto, in dem Sie Ihre Azure Blob-Speicherkonten anzeigen möchten.
